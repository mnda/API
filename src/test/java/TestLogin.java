...
public class TestLogin {
    ...
    public void testFBLoginInvalid() {
        ...
        Assert.assertEquals("Expected and Actual Response does not match",TestData.TestLoginExpectedResults.COULD_NOT_AUTHENTICATE_RESPONSE,responseBody);
    }
    ...
    public void testSuspendedEmailLoginInvalid() {
        ...
        Assert.assertEquals("Expected and Actual Response does not match",TestData.TestLoginExpectedResults.SUSPENDED_ACCOUNT_RESPONSE,responseBody);
    }
